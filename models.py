...
class Store(BaseModel):
   ...
   def validate(self):
      ...
      if duplicate_stores:
         self.errors.append('This name is not unique. Submit another name.')
...
class Warehouse(BaseModel):
   ...
   def validate(self):
      duplicate_warehouses = Warehouse.get_or_none(Warehouse.store_id == self.store_id)

      if duplicate_warehouses:
         self.errors.append('This store already has a warehouse!')
